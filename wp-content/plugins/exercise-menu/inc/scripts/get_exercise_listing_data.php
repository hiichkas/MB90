...
//$progExercises = $wpdb->get_results("SELECT * FROM mb90_prog_exercises_translated WHERE ProgrammeID = " .$progSelected. " ORDER BY ProgrammeID, ExerciseDay, ExerciseName limit $offset,$pageRows", OBJECT);
$progExercises = $wpdb->get_results("SELECT * FROM mb90_prog_exercises_translated WHERE ProgrammeID = " .$progSelected. " ORDER BY ProgrammeID, ExerciseDay, ExerciseName", OBJECT);
