...
$progExercises = $wpdb->get_results("SELECT * FROM mb90_prog_exercises_translated_frontend WHERE ProgrammeID = " .$progSelected. " ORDER BY ProgrammeID, ExerciseDay", OBJECT);
