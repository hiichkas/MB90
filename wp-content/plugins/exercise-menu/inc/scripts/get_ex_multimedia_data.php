...
// get all exercise multimedia data to display in grid
$exerciseMM = $wpdb->get_results("SELECT * FROM mb90_exercise_multimedia_translated ORDER BY ExerciseTypeID", OBJECT);
