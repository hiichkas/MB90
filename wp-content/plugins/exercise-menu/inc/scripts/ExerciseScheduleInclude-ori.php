        ...
        for($rowCount = 1; $rowCount <= 90; $rowCount ++ )
        {
            ...
            //{
                ...
                //if( $dayOfCourse == $fullDayCount){
                    ...
                    if( in_array($fullDayCount%10, $nonWorkoutDaysArr, true))
                        if( $fullDayCount%10 == 1){
                            $link = '<a href="../self-assessment" title="Day ' . $fullDayCount. ' (Self Assessment)">';
                        }else if( $fullDayCount%10 === 0){
                            $link = '<a href="../10-day-challenge" title="Day ' . $fullDayCount. ' (10 Day Challenge)">';
                        }
                        else{
                            $link = '<a href="../your-exercise-details-post-' . $fullDayCount%10 . '" title="Day ' . $fullDayCount. ' (Rest Day)">';
                        }
                    else
                        $link = '<a href="../your-exercise-details?exday=' . $fullDayCount . '" title="Day ' . $fullDayCount. ' (Workout)">';                
                //}else{
...
/*        foreach( $rowHTMLArr as $rowHTMLstr){
    ...
    function GetExerciseScheduleJs($incPath)
    {
        //echo '<script src="'.$incPath.'js/timer/tabata-timer.js" type="text/javascript"></script>';
        //echo '<script src="//code.jquery.com/ui/1.11.4/jquery-ui.js" type="text/javascript"></script>';
        echo '<script src="'.$incPath.'js/exercise-schedule/exercise-schedule.js" type="text/javascript"></script>';
    }
