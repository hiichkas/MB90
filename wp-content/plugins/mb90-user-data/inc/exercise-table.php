...
{
    global $wpdb;
    //$table_name = $wpdb->prefix . 'mb90_prog_exercises'; // do not forget about tables prefix
    $table_name = 'mb90_prog_exercises'; // do not forget about tables prefix
...
<div class="wrap">
    <div class="icon32 icon32-posts-post" id="icon-edit"><br></div>
    <h2><?php _e('Exercise', 'custom_table_example')?> <a class="add-new-h2"
                                href="<?php echo get_admin_url(get_current_blog_id(), 'admin.php?page=mt-top-level-handle');?>"><?php _e('back to list', 'custom_table_example')?></a>
    </h2>
        ...
        <div class="metabox-holder" id="poststuff">
            <div id="post-body">
                <div id="post-body-content">
                    ...
                    <?php do_meta_boxes('excercise', 'normal', $item); ?>
