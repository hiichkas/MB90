  ...
  */
  ...
  public function display_payment_form($amount, $user, $product_id, $txn_id) {
    ...
    <div class="mp_wrapper">
      <form action="<?php //echo $prd->url('',true); //COMMENTING THIS OUT FOR https://github.com/caseproof/memberpress/issues/790  ?>" method="post" id="payment-form" class="mepr-form" novalidate>
