...
<link rel="stylesheet" type="text/css" href="<?=$incURL?>css/myBody90-user-input.css">
    ...
    else
    {
        ...
        if( isset($_REQUEST["challengeDate"]) ) // 10 day challenge date has been chosen
        {
            ...
            if( count($chartDataValArray) > 0)
            {
                ...
                for($i = 0; $i < $numExercises; $i++)
                {
                    ...
                    echo '<canvas id="canvas_'.($i+1).'" height="200px" width="auto"></canvas>111'."\r\n";
                    //echo '</div>';
                    echo '</div>';
        ...
        if( $showGraphs )
        {
            ...
            foreach($captionArray as $caption )
            {
                ...
                echo '<div class="mb90-chart-contents">';
                echo '<canvas id="canvas_'.($count+1).'" height="200px" width="300px"></canvas>333'."\r\n";
                echo '</div>';
                //echo '</div>';
