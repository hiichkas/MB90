  ...
  <div id="mepr-rules-form">
    ...
    <div class="mepr-main-pane">
      ...
      <div id="partial_content_codes_hidden">
        <?php _e('Shortcode:', 'memberpress'); ?> <strong>[mepr-show if="rule: <?php echo $rule->ID; ?>"] </strong><?php _e('Content to protect goes inbetween.', 'memberpress'); ?><strong> [/mepr-show]</strong>
        <br/><br/>
