...
class datagrid
{
    function getFormInputs($gridType)
    {
        ...
        {
            $orderDD = $this->getIntDD("exercise_order", 20, "required='true'", "editable='false'");
            ...
            $formInputHTML .= '<div class="fitem"><label>Order #:</label>' . $orderDD . '</div>';
...
//            $formInputHTML .= '<div class="fitem" id="imagerow"><label>Image Upload:</label><input class="easyui-filebox" id="ExerciseMMPathImage" name="ExerciseMMPath" data-options="prompt:\'Choose a file...\'" style="width:100%">';
    ...
    function getGridHeader($gridType)
    {
        ...
        if( $gridType == "Exercise")
        {
            ...
            $headerHTML .= '<th field="OrderNumber" width="10">Order #</th>';
            $headerHTML .= '<th field="ExerciseDay" width="10">Day</th>';
    ...
    function getIntDD($name, $length, $required, $editable)
    {
            $dropdownID = "OrderNumber";
            $tableID = "ID";
